...
<quote>He is a technician. He is not an expert, just a guy forced to figure it out on the job.</quote>
<stats>
<stat label="Role">Syndicate Leader &amp; Electrician Student</stat>
<stat label="Vehicle Blueprints">SUV</stat>
...
<lore>
<p>Bran Davis is a guy who wanted to be an electrician. Because he could not find an apprenticeship, he took a job in the system.</p>
<p>When the Derrulicants attacked his platform on Startis, he fled in his SUV. He was promoted to captain of the vessel after the captain died of a disease.</p>
<p>Despite having zero background, his expertise with rigging and circuitry makes him the heartbeat of the human resistance.</p>
</lore>
<extra>System Record: Bran Davis desk contains a relic—a Dell L100 keyboard with the logo pried off. His SUV carries 125 additional HP and 2 additional armor on difficulties to buffer player error, scaling down to stats on Hard. In combat, Bran deals less damage than typical hero units to reflect his background.</extra>
</entry>
...
<category>Character</category>
<tagClass>tag-character</tagClass>
<quote>A ruler hiding behind monitors to protect a legacy.</quote>
<stats>
<stat label="Faction Role">Supreme Sovereign of the Purists</stat>
<stat label="Visual Presence">Communicates via blue holograms</stat>
<stat label="Inspiration">General Horatio Gates</stat>
<stat label="Psychological State">Paranoia &amp; Insomnia</stat>
</stats>
<lore>
<p>Prius served as a ship captain during the battle that witnessed the Destruction of the Star Forge. Instead of fighting, Prius hid his cruiser due to flight log errors and an engine failure, hiding his cowardice from his crew.</p>
<p>The dread of his desertion being unearthed has driven him insane. He rules his empire behind a curtain of surveillance and holograms.</p>
<p>He orchestrated the war against the Derrulicants to dismantle a rival Star Forge project on Startis, burying proof of his cowardice.</p>
</lore>
<extra>System Record: Prius tracks the 25 surviving derelict Enclave ships that escaped the Star Forge explosion, seeking to destroy them before any crew can expose his history.</extra>
</entry>
...
<category>Character</category>
<tagClass>tag-character</tagClass>
<quote>Jeffery is gone. His armor suit is steered by the mind of Dr. Glenn Stafford.</quote>
<stats>
<stat label="Faction Alignment">Biomass Hive Mind</stat>
<stat label="Host Identity">Former BMO Officer Jeffery (ID #033198)</stat>
<stat label="Physical Symptom">Armor joint twitches and spasms</stat>
<stat label="Cause">Metabolic body-heat stabilizer</stat>
</stats>
<lore>
<p>During the days of the crisis on Earth, Jeffery was an officer in the BMO team. After his patrol was wiped out, his armor was hijacked by the consciousness of researcher Dr. Glenn Stafford.</p>
<p>Stafford injected himself with a DNA Stabilizer corrupted by pathogen cells. While Biomass creatures are mindless, his mind possesses the coordination to direct the swarm.</p>
<p>He behaves twitchily because his suit stabilizer distributes metabolic body heat unevenly across extremity modules during the merge, disrupting joint power systems.</p>
</lore>
<extra>Easter Egg: Jeffery BMO Officer ID is #033198, a reference to the release date of the original StarCraft (March 31, 1998). Stafford is also named after Glenn Stafford, Starcraft composer.</extra>
</entry>
...
<category>Character</category>
<tagClass>tag-character</tagClass>
<quote>An operative facing down a biological collapse.</quote>
<stats>
<stat label="Official ID">#072710 (BMO Archives)</stat>
<stat label="Deployment Zone">BMO Earth Headquarters</stat>
<stat label="Primary Vehicle">BMO Screening Truck</stat>
<stat label="Status">Killed in Action</stat>
</stats>
<lore>
<p>Tanner was an officer for the Biomass Management Organisation (BMO) on Earth. When his team was slaughtered during an outbreak, Tanner navigated the quarantine zone alone.</p>
<p>He located BMO headquarters and coordinated an evacuation helicopter, only to have the blades destroyed by biological anomalies, crashing him back into the wasteland.</p>
<p>He sacrificed his life by destroying the escape rocket in mid-launch, choosing death to ensure the mutating Biomass pathogen could not spread to solar systems.</p>
</lore>
<extra>System ID Note: Tanner registration number #072710 is a reference to July 27, 2010—the release date of StarCraft II: Wings of Liberty.</extra>
</entry>
...
<category>Character</category>
<tagClass>tag-character</tagClass>
<quote>Left unarmed and unarmored in a wasteland, Jamison fights with grit.</quote>
<stats>
<stat label="Armor Frame">15% larger than Syndicate suits</stat>
...
<lore>
<p>Jamison was deployed aboard a security shuttle dispatched during the crash-landing of a Blue Ops ship downed by fire. During descent, his shuttle wing was sheared off, popping the locks on the crew module.</p>
<p>He managed to claw open a safety rack bare-handed, climbing into his exo-suit right before impact. Although his rifle fell off a cliff during a biological ambush, Jamison beat the creatures with his fists.</p>
<p>He is left stranded in the wasteland after hydraulic line leaks forced him to eject his chestplate to survive.</p>
</lore>
</entry>
...
<category>Character</category>
<tagClass>tag-character</tagClass>
<quote>The captain of the Syndicate command ship whose death promoted Bran Davis.</quote>
<stats>
...
<lore>
<p>The former captain of Bran command ship died shortly after arrival in the system. His death was kept quiet by the command staff.</p>
<p>He succumbed to the Earth-born pathogen due to a genetic loophole: his parents immunity methods crossed in a manner that nullified his immunity by age 30.</p>
<p>The evidence of his passing is a purple stain in his private quarters, left behind during his cellular collapse.</p>
</lore>
</entry>
...
<category>Character</category>
<tagClass>tag-character</tagClass>
<quote>An official who paid the price for revealing Prius cowardice.</quote>
<stats>
...
<lore>
<p>An elder within the Enclave ruling council who discovered the files of Prius desertion during the destruction of the Star Forge.</p>
<p>He contacted Bran Davis, leaking proof of Prius corruption and his hidden schemes to destroy the Derrulicants to silence rival projects.</p>
<p>Right after Bran attempted to verify this information, the elder was found dead in his quarters, orchestrating the split between the Syndicate and Enclave.</p>
</lore>
</entry>
...
<category>Character</category>
<tagClass>tag-character</tagClass>
<quote>A tyrant piloting a biological system.</quote>
<stats>
<stat label="Jurisdiction">Torus VI Core Command</stat>
<stat label="Genetic Status">Infected yet fully sentient</stat>
<stat label="Stabilizers Held">4 Active Syncon Stasis Stabilizers</stat>
</stats>
<lore>
<p>The Supreme Commander of the Derrulicants. He rules the stronghold of &lt;span class='wiki-link' data-id='torus-purge'&gt;Torus VI&lt;/span&gt; with efficiency.</p>
...
<p>This biological engineering makes him immortal, preserving his intellect even as his body undergoes mutations.</p>
</lore>
</entry>
...
<quote>Infantry wearing repurposed cargo-stacking gear.</quote>
<stats>
...
<lore>
<p>The infantry of the Syndicate consists of miners and construction workers piloting modified 1.5-ton industrial pallet stackers retrofitted with machine guns.</p>
<p>The suit 5 HP advantage over standard RTS templates comes from a microscopic amount of Caspium dust added into the plating during fabrication. However, inhaling this dust can cause terminal lung cancer.</p>
</lore>
<extra>Secret File: Syndicate soldiers are notorious for manually overriding their suit internal water storage, dumping moonshine or fermented fruit mash directly into their water filters to get through their long watch-shifts. Many soldiers are survivors of minor genetic pathogen deficiencies given frontline roles.</extra>
</entry>
...
<category>Syndicate Unit</category>
<tagClass>tag-syndicate</tagClass>
<quote>Field mechanic used to build bases and repair mechanical units.</quote>
<stats>
<stat label="Production Facility">&lt;span class='wiki-link' data-id='conscription-center'&gt;Conscription Center&lt;/span&gt;</stat>
...
<category>Syndicate Unit</category>
<tagClass>tag-syndicate</tagClass>
<quote>Advanced, armored tactical infantry.</quote>
<stats>
<stat label="Production Facility">&lt;span class='wiki-link' data-id='conscription-center'&gt;Conscription Center&lt;/span&gt;</stat>
...
<category>Syndicate Unit</category>
<tagClass>tag-syndicate</tagClass>
<quote>Frontline brawler, immune to fire, volatile.</quote>
<stats>
<stat label="Production Facility">&lt;span class='wiki-link' data-id='conscription-center'&gt;Conscription Center&lt;/span&gt;</stat>
...
<lore>
<p>The tactical Support Vehicle serves as the cover unit of Proxima. Triggering its self-destruct command instantly ejects a defensive field of five cloaked proximity mines to block base entry. Units disembark 2 per side from left to right when unloaded.</p>
</lore>
</entry>
...
<lore>
<p>The Sentry cannot attack unless anchored in its deployed mode. When deployed, it acts as a radar station, granting +1 range, exposing cloaked units, and gaining a +40% fire-rate bonus for each additional sieged Sentry nearby. Pneumatic firing triggers bullet acoustics.</p>
</lore>
</entry>
...
<category>Syndicate Unit</category>
<tagClass>tag-syndicate</tagClass>
<quote>Frontline combat mech suit.</quote>
<stats>
<stat label="Production Facility">&lt;span class='wiki-link' data-id='factory'&gt;Factory&lt;/span&gt;</stat>
...
<category>Syndicate Unit</category>
<tagClass>tag-syndicate</tagClass>
<quote>Hovering support unit against biological swarms.</quote>
<stats>
...
<lore>
<p>Aero Drones are maneuverable scouts. Activating Overcharger mode slows their propulsion but increases their fire rate to 100 rounds per second, vaporizing biological swarms.</p>
</lore>
</entry>
...
<lore>
<p>The human vehicle, retrieved from the hangars of demobilized cryo-ships. Most weapons in the system are reverse-engineered from Valkyrie parts.</p>
</lore>
</entry>
...
<category>Syndicate Unit</category>
<tagClass>tag-syndicate</tagClass>
<quote>Planetary gunship; requires ground escorts.</quote>
<stats>
<stat label="Production Facility">&lt;span class='wiki-link' data-id='space-center'&gt;Space Center&lt;/span&gt;</stat>
...
<lore>
<p>Modified from cargo transport frames designed by BSC Inc. While carrying anti-ground and anti-air missile packages, its reliance on dual VTOL turbofans makes it slow to lift if one turbofan is destroyed. Syndicate space force flagships like Supercarriers and Nailheads dominate orbital space.</p>
</lore>
</entry>
...
<quote>Slow, shielded mechanical walker.</quote>
<stats>
...
<lore>
<p>The Archon utilizes Enclave shielding technology. Its hard-light shielding absorbs incoming ballistic impacts, allowing its thermal laser to melt through armor.</p>
</lore>
</entry>
...
<category>Enclave Unit</category>
<tagClass>tag-enclave</tagClass>
<quote>Early-to-mid game armored vehicle.</quote>
<stats>
...
<lore>
<p>The armored vehicle of the Enclave, utilizing concentrated plasma orbs to dissolve fortifications.</p>
</lore>
</entry>
...
<lore>
<p>Pioneers are walking shields, built to march directly into dense bases to absorb return fire.</p>
</lore>
</entry>
...
<lore>
<p>A fast scout designed to ignite light infantry, though its low base damage makes it useless against heavy armor.</p>
</lore>
</entry>
...
<category>Enclave Unit</category>
<tagClass>tag-enclave</tagClass>
<quote>Late-game armored walker.</quote>
<stats>
<stat label="Production Facility">&lt;span class='wiki-link' data-id='advanced-fabricator'&gt;Advanced Fabricator&lt;/span&gt;</stat>
...
<lore>
<p>The Python represents the peak of the Enclave armored division, delivering high-impact plasma bursts designed to compromise vehicle hulls.</p>
</lore>
</entry>
...
<lore>
<p>The Harpy uses a Charged Lance that deals continuous damage, increasing in output the longer its laser beam remains locked onto a target.</p>
</lore>
</entry>
...
<lore>
<p>A floating platform that drifts over battlefields, firing its four ion turrets to dissolve ground and air threats.</p>
</lore>
</entry>
...
<lore>
<p>Phosphate drones are volatile, cheap kamikaze units programmed to launch into air swarms and detonate to clear airspace.</p>
</lore>
</entry>
...
<lore>
<p>The Standard Strain melee unit, utilizing claws coated in a biological acid (pH 1.2) to slice through metal plating.</p>
</lore>
</entry>
...
<lore>
<p>Feral biters expand with pressurized digestive acid (pH 0.8), charging into mechanical clusters to rupture and explode upon contact.</p>
</lore>
</entry>
...
<category>Biomass Unit</category>
<tagClass>tag-biomass</tagClass>
<quote>Primal shock-trooper.</quote>
<stats>
<stat label="Production Facility">&lt;span class='wiki-link' data-id='incubation-chamber'&gt;Incubation Chamber&lt;/span&gt;</stat>
<stat label="Cost">75 Stone / 0 Metal / 15 Oil / 0 Caspium</stat>
<stat label="Supply / Build Time">2 Supply / 18s</stat>
...
<lore>
<p>The muscle of the Primal strain, shrugging off minor wounds to crush armored defenses.</p>
</lore>
</entry>
...
<category>Biomass Unit</category>
<tagClass>tag-biomass</tagClass>
<quote>Mid-game ranged artillery.</quote>
<stats>
...
<lore>
<p>The ranged support for the Standard strain, firing digestive bile from a safe distance to dissolve infantry.</p>
</lore>
</entry>
...
<lore>
<p>Though dealing acid spray, Gaggers make a loud gagging noise that can be heard through the fog of war by enemies. Excellent for dissolving Incinerators or Archons.</p>
</lore>
</entry>
...
<lore>
<p>Primal hunters that fire calcified spikes to punch holes through metal tanks and mechs.</p>
</lore>
</entry>
...
<lore>
<p>Acts as a fortified bunker. While it can uproot and walk on limbs, moving off creep or losing the underlying slime causes death.</p>
</lore>
</entry>
...
<category>Biomass Unit</category>
<tagClass>tag-biomass</tagClass>
<quote>Siege beast, ignores armor.</quote>
<stats>
<stat label="Production Facility">&lt;span class='wiki-link' data-id='spore-accumulator'&gt;Spore Accumulator&lt;/span&gt;</stat>
...
<lore>
<p>Ignores 50% of the target armor. However, if the player selects the Acid strain, Titans burrow underground and become inactive.</p>
</lore>
</entry>
...
<category>Biomass Unit</category>
<tagClass>tag-biomass</tagClass>
<quote>Flying pest for harassment.</quote>
<stats>
...
<lore>
<p>Aerial pests designed to harass workers and scout ahead of the swarm.</p>
</lore>
</entry>
...
<category>Biomass Unit</category>
<tagClass>tag-biomass</tagClass>
<quote>Slow-flying interceptor.</quote>
<stats>
<stat label="Production Facility">&lt;span class='wiki-link' data-id='corea'&gt;Corea&lt;/span&gt;</stat>
<stat label="Cost">50 Stone / 50 Metal / 100 Oil / 10 Caspium</stat>
<stat label="Supply / Build Time">2 Supply / 24s</stat>
...
<lore>
<p>Aerial defenders that fire calcified bone lances to dominate skies.</p>
</lore>
</entry>
...
<lore>
<p>Lashes out with tentacles, dragging light targets into its central crushing maw with a chance to kill them.</p>
</lore>
</entry>
...
<category>Biomass Unit</category>
<tagClass>tag-biomass</tagClass>
<quote>Biological siege tank.</quote>
<stats>
<stat label="Production Facility">&lt;span class='wiki-link' data-id='corea'&gt;Corea&lt;/span&gt;</stat>
<stat label="Cost">0 Stone / 75 Metal / 50 Oil / 50 Caspium</stat>
...
<lore>
<p>The bio-artillery unit, firing bone-shielded spore pods to punch through base fortifications.</p>
</lore>
</entry>
...
<category>Production Structure</category>
<tagClass>tag-structure</tagClass>
<quote>Manufacturing plant for Syndicate mechanized chassis.</quote>
<stats>
<stat label="Faction Owner">The Syndicates</stat>
...
<lore>
<p>Constructs chassis modified from pre-war logistics machinery.</p>
...
<p>Fields rapid biological &lt;span class='wiki-link' data-id='steward'&gt;Stewards&lt;/span&gt; to absorb incoming fire, and shielded &lt;span class='wiki-link' data-id='archon'&gt;Archon&lt;/span&gt; walker systems.</p>
</lore>
</entry>
...
<category>Production Structure</category>
<tagClass>tag-structure</tagClass>
<quote>Enclave mechanical bay assembling planetary mechs.</quote>
<stats>
<stat label="Faction Owner">The Enclave</stat>
...
<lore>
<p>Welds steel plating onto automated vehicle platforms.</p>
...
<category>Production Structure</category>
<tagClass>tag-structure</tagClass>
<quote>Enclave forge for the highest-tier planetary dominators.</quote>
<stats>
<stat label="Faction Owner">The Enclave</stat>
...
<lore>
<p>Requires levels of Caspium power to run. Launches agile &lt;span class='wiki-link' data-id='speeder'&gt;Speeders&lt;/span&gt; for reconnaissance and the massive, armored &lt;span class='wiki-link' data-id='python'&gt;Pythons&lt;/span&gt;.</p>
</lore>
</entry>
...
<category>Production Structure</category>
<tagClass>tag-structure</tagClass>
<quote>The spawning pit of the biological swarm.</quote>
<stats>
...
<stat label="Structural Role">Ranged &amp; Organic Spawner</stat>
</stats>
<lore>
<p>Evolves organism lines. Generates basic &lt;span class='wiki-link' data-id='spitter'&gt;Spitters&lt;/span&gt;, sensory &lt;span class='wiki-link' data-id='gagger'&gt;Gaggers&lt;/span&gt;, and the massive, armor-smashing &lt;span class='wiki-link' data-id='titan'&gt;Titans&lt;/span&gt;.</p>
</lore>
</entry>
...
<category>Production Structure</category>
<tagClass>tag-structure</tagClass>
<quote>Biomass flight nest and support center.</quote>
<stats>
<stat label="Faction Owner">The Biomass Swarm</stat>
<stat label="Primary Units Spawned">Stalker, Leech, Vulture, Carrion, Vomiter, Husk</stat>
<stat label="Structural Role">Flying &amp; Support Nest</stat>
</stats>
<lore>
<p>The peak of biological adaptation. Fields aerial pests like &lt;span class='wiki-link' data-id='stalker'&gt;Stalkers&lt;/span&gt; and support units like the massive &lt;span class='wiki-link' data-id='husk'&gt;Husk&lt;/span&gt; spore-cannoneer.</p>
</lore>
</entry>
...
<stat label="Melee Feature">Steel bashing plate on the right</stat>
...
<lore>
<p>The standard-issue firearm of the Syndicate. It is crafted with thick steel siding to allow infantry to club threats when ammunition runs dry.</p>
<p>Modified by some soldiers to fire shotgun shells, though this modification remains illegal.</p>
</lore>
</entry>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Armor-penetrating assault rifle of hero units.</quote>
<stats>
<stat label="Manufacturer">&lt;span class='wiki-link' data-id='alaby-inc-corp'&gt;Alaby Inc&lt;/span&gt;</stat>
...
<lore>
<p>The firearm used by hero units. Its high-velocity firing mechanism punches straight through standard armor.</p>
</lore>
</entry>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Fuel flamers mounted on Incinerator suits.</quote>
<stats>
...
<lore>
<p>Dangerous, uninsulated fuel hoses that spray burning gel in a front cone to clear biological creep.</p>
</lore>
</entry>
...
<lore>
<p>Fires medical-grade kinetic needles carrying biological agents to defend the operative while on deployment.</p>
</lore>
</entry>
...
<lore>
<p>A tactical mechanism that vaporizes the deploying vehicle to create a defensive mine field.</p>
</lore>
</entry>
...
<lore>
<p>Fires homing missiles that lock onto enemy flyers, serving as a counter against air rushes.</p>
</lore>
</entry>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Rapid ballistic machine gun.</quote>
<stats>
...
<lore>
<p>An automated kinetic turret used for defense and screening light attackers.</p>
</lore>
</entry>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Rapid shell launcher.</quote>
<stats>
...
<lore>
<p>A fast shell dispenser ideal for chewing through light biological units and soft vehicles.</p>
</lore>
</entry>
...
<lore>
<p>Launches guided missiles configured to slice through mechanical armor plating.</p>
</lore>
</entry>
...
<lore>
<p>A suppression gun designed to disintegrate biological swarms of light biters.</p>
</lore>
</entry>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Atmospheric plasma-torpedo system.</quote>
<stats>
<stat label="Target Profile">AIR ONLY</stat>
...
<lore>
<p>Military homing torpedos retrieved from demilitarized war hangar vaults.</p>
</lore>
</entry>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Tactical airship rocket.</quote>
<stats>
...
<lore>
<p>An ordnance launcher deployed to flatten base structures and clear air formations.</p>
</lore>
</entry>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Focused thermal energy beam.</quote>
<stats>
...
<lore>
<p>An energy weapon designed by Enclave scholars to slice cleanly through armor columns.</p>
</lore>
</entry>
...
<lore>
<p>Steady energy rifle providing combat suppression to front-line walkers.</p>
</lore>
</entry>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Energy lance, tuned against bio threats.</quote>
<stats>
...
<lore>
<p>Tuned down against metal structures, but effective against swarms of flesh-based targets.</p>
</lore>
</entry>
...
<lore>
<p>An Enclave aerial system. The beam ramps up in damage the longer the harpy remains focused on a target.</p>
</lore>
</entry>
...
<lore>
<p>A capital energy system capable of engaging multiple targets across combat horizons.</p>
</lore>
</entry>
...
<lore>
<p>The biological attack of the biter, relying on numbers to chew through alloy hulls.</p>
</lore>
</entry>
...
<lore>
<p>Secretes a biological acid (pH 1.2) that melts down vehicle plating during close combat engagement.</p>
</lore>
</entry>
...
<lore>
<p>A volatile biological defense mechanism where the organism self-destructs to release corrosive fluids.</p>
</lore>
</entry>
...
<lore>
<p>Ranged attack of the Biomass, launching corrosive fluid from distance.</p>
</lore>
</entry>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Biochemical stream.</quote>
<stats>
...
<lore>
<p>A close-range spray. The weapon produces a loud sound.</p>
</lore>
</entry>
...
<lore>
<p>A kinetic stomp that ignores metal armoring grids entirely.</p>
</lore>
</entry>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Biological needle launcher.</quote>
<stats>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Bone-lance launcher.</quote>
<stats>
<stat label="Base Damage">15 Damage</stat>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Biological pulling tentacles.</quote>
<stats>
...
<lore>
<p>Muscular lashes designed to pull enemy infantry into the maw.</p>
</lore>
</entry>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Biological chemical sprayer.</quote>
<stats>
...
<lore>
<p>Coats choke barriers in acidic mist that melts infantry columns over time.</p>
</lore>
</entry>
...
<category>Weapon</category>
<tagClass>tag-weapon</tagClass>
<quote>Organic siege mortar.</quote>
<stats>
<stat label="Base Damage">30 [+20 vs Armored]</stat>
...
<lore>
<p>Fires calcified explosive pods to crack human bases from distances.</p>
</lore>
</entry>
...
<quote>A metal that absorbs kinetic impact and turns it into heat.</quote>
<stats>
<stat label="Market Value">200,000c / kg</stat>
<stat label="Conductivity">Poor Conductor</stat>
<stat label="Workability">Cannot be machined or hammered; can only be cast</stat>
</stats>
<lore>
<p>Caspium kinetic-reacts, converting ~20,000 joules per bullet into 4,000°C thermal spikes. Consequently, vehicles in combat melt on-screen during combat.</p>
...
<extra>Technical File: Hitting Caspium with a lathe or steel hammer can trigger a thermal flash. To shield occupants, plates must be encased in nonconductive &lt;span class='wiki-link' data-id='steeline'&gt;Steeline&lt;/span&gt; cooling channels.</extra>
</entry>
...
<category>Material</category>
<tagClass>tag-material</tagClass>
<quote>Structural alloy used to isolate Caspium plates.</quote>
<stats>
<stat label="Refining Duration">~2 Months per batch</stat>
<stat label="Primary Property">Thermal resilience and insulation</stat>
<stat label="Conductivity">100% Nonconductive</stat>
</stats>
<lore>
<p>A valuable, heavy alloy made of steel, tungsten, and elements, used primarily to build space superstructures like the Star Forge.</p>
<p>Because of its thermal resilience, it is wrapped around Caspium plates, allowing them to absorb bullets and cool down without cooking the vehicle pilot.</p>
</lore>
</entry>
...
<category>Material</category>
<tagClass>tag-material</tagClass>
<quote>Syncon Inc stasis units that protected human genes during the drift.</quote>
<stats>
...
<lore>
<p>The stabilizers used by the Syndicates during their journey to the system.</p>
<p>Because the system is powered by metabolic body heat, any genetic error or system collapse causes power distribution to stutter, leading to physical spasms.</p>
</lore>
</entry>
...
<quote>The organization tasked with cataloging human DNA collapse.</quote>
<stats>
...
<lore>
<p>The Biomass Management Organisation (BMO) was established to isolate infected zones on Earth. They monitored disease progression but were overrun during the containment breach. BMO exo-suits utilize a backpack lithium-ion power bank with pneumatic pack-ejection mechanisms.</p>
</lore>
</entry>
...
<category>Pre-War Corporation</category>
<tagClass>tag-company</tagClass>
<quote>The shipbuilders who built the vessels that saved human history.</quote>
<stats>
...
<lore>
<p>Charcoal Military manufactured the exploratory warships that transported the frozen human refugees. Due to resource limits, these vessels carried infantry armor and Valkyrie fighters.</p>
</lore>
</entry>
...
<category>Pre-War Corporation</category>
<tagClass>tag-company</tagClass>
<quote>Pioneers of deep-space propulsion, thrusters, and navigation.</quote>
<stats>
...
<lore>
<p>Designed the engine templates used across human spacecraft, specializing in VTOL systems for cargo lifting.</p>
</lore>
</entry>
...
<lore>
<p>Syncon Inc designed the cryo-chambers and metabolic heat-powered stabilizers that kept the refugees safe during their voyage.</p>
</lore>
</entry>
...
<category>Pre-War Corporation</category>
<tagClass>tag-company</tagClass>
<quote>Developers of ballistic weapon frameworks.</quote>
<stats>
<stat label="Specialty">Ballistics and solid-ammo rifles</stat>
<stat label="Signature Weapons">CD-12 Assault Rifle, CD-13 Rifle</stat>
</stats>
<lore>
<p>Alaby Inc focused on designing infantry weaponry with steel casings to survive industrial labor and frontline mining clashes.</p>
</lore>
</entry>
...
<quote>Versatility countered by armor limits and drill EMP vulnerabilities.</quote>
<stats>
...
<lore>
<p>The Syndicates use low-voltage 500V 30A AC electrical sockets across base facilities. Because mining drills rely on electronic components, striking a Syndicate drill with an EMP shuts down resource extraction for 8 seconds.</p>
<p>Due to a structural understanding of Caspium, Syndicate armor caps out early, forcing players to win through swift early-to-mid game aggression.</p>
</lore>
</entry>
...
<category>Faction Rule</category>
<tagClass>tag-rule</tagClass>
<quote>Adaptation and creep expansion vulnerable to fire and quarry burning.</quote>
<stats>
<stat label="Strain Switch Cost">200 Caspium (Switches between Normal, Acid, Primal)</stat>
<stat label="Creep Vulnerability">Flammable; burns without secretion nodes</stat>
<stat label="Quarry Weakness">Takes 3x damage from thermal/fire weapons</stat>
</stats>
<lore>
<p>Biomass structures rely on grey exudate creep trails to function and build. This creep is flammable; if set alight without secretion nodes using Caspium to extinguish the fire, colonies can incinerate. Biomass quarries also take 3x damage from thermal attacks.</p>
<p>Biomass players can switch strains (Standard Kinetic, Acid vs Light, Primal vs Heavy) at any time for 200 Caspium. Biomass metabolizes Caspium from destroyed vehicles into armor, though this is excluded from active match mechanics.</p>
</lore>
</entry>
...
<category>Faction Rule</category>
<tagClass>tag-rule</tagClass>
<quote>Late-game units limited by power grids and Caspium costs.</quote>
<stats>
<stat label="Structure Aesthetics">Golden casing made of pre-Forge Caspium</stat>
<stat label="Defense Requirement">Requires Caspium generators or Beam Towers</stat>
<stat label="Construction Rule">Defenses cannot build while structures take damage or attack</stat>
</stats>
<lore>
<p>Enclave defensive structures build using Stone, but cannot function without Caspium-fueled power generators or Beam Towers. Base expansion is constrained because defenses cannot be constructed near combat or damaged structures.</p>
<p>Combat units and structures require Caspium, forcing the Enclave to play conservatively and save for an unstoppable late-game push.</p>
</lore>
</entry>
...
<category>Faction Rule</category>
<tagClass>tag-rule</tagClass>
<quote>Resource layout required to maintain Enclave faction balance.</quote>
<stats>
...
<lore>
<p>Every competitive map in Proxima must adhere to this layout template. Because the Enclave is dependent on Caspium for combat structures, deviating from these resource node ratios renders the faction unplayable.</p>
</lore>
</entry>
...
<quote>The disaster that shattered the Enclave empire and created the Biomass.</quote>
<stats>
...
<lore>
<p>The Star Forge was a Steeline truss-structured Dyson sphere surrounding Caspius XII to cast Caspium. When the Ravenous attacked the outer control centers, the arriving Enclave warfleet overwhelmed them.</p>
<p>Faced with defeat, the Ravenous detonated the skeletal structural ligaments. Torsion forces pulled half of the Dyson Sphere into the star, compromising its nuclear fusion.</p>
<p>0.000083 seconds after impact, 99% of onboard survivors were dead. In 30 seconds, the star compressed into an asteroid-sized core before triggering a supernova that melted the fleeing Enclave fleet into Caspium-rich asteroid belts around white dwarf Caspius XII-d.</p>
</lore>
</entry>
...
<category>Major Event</category>
<tagClass>tag-event</tagClass>
<quote>The disaster that killed Earth and forced humanity drift.</quote>
<stats>
...
<lore>
<p>The Biomass disease began on Earth via infected meat, bypassing the human blood-brain barrier by infecting filter cells. It progresses through 7 stages: initial high fever (Stage 1), temporary recovery (Stage 2), immune cell death (Stage 3), blood-brain barrier dissolution and 3-day cognitive decline (Stage 4), brain death with nervous network formation (Stage 5), motor skill recovery as a new species (Stage 6), and hostile swarm behavior in 3-8 weeks (Stage 7).</p>
<p>To save humanity, a fleet of training vessels was launched. Passengers were frozen inside cryo-pods equipped with &lt;span class='wiki-link' data-id='dna-stabilizer'&gt;DNA Stabilizers&lt;/span&gt; to develop resistance over thousands of years.</p>
<p>The drift immunized the survivors, but transformed them into carriers whose immunities produce vulnerable offspring.</p>
</lore>
</entry>
...
<category>Major Event</category>
<tagClass>tag-event</tagClass>
<quote>The planetary escape attempt on Earth that exposed the Biomass.</quote>
<stats>
...
<lore>
<p>During the collapse on Earth, Tanner rescued his colleague Jeffery, who was secretly a flesh-puppet guided by the mind of &lt;span class='wiki-link' data-id='stafford'&gt;Dr. Glenn Stafford&lt;/span&gt;.</p>
<p>Stafford attempted to hijack a Proxima-bound colonial rocket to seed systems. Tanner boarded the craft during launch and detonated it, sacrificing his life to save humanity.</p>
</lore>
</entry>
...
<category>Major Event</category>
<tagClass>tag-event</tagClass>
<quote>The operation to crash an infested space station containing 4 billion people.</quote>
<stats>
...
<stat label="Result">Station pulled into orbit, vaporized</stat>
</stats>
<lore>
<p>Torus VI was the industrial capital of the Derrulicants. During the final stage of the war, the rotating station was overrun by the Biomass swarm.</p>
<p>To prevent contamination, the Syndicate and Enclave launched a joint strike to unlock three magnetic locks anchored across planets.</p>
<p>Shifting the magnetic locks dragged the space station out of orbit, crashing it directly into a planet below to incinerate the biological hosts.</p>
</lore>
</entry>
...
<category>Major Event</category>
<tagClass>tag-event</tagClass>
<quote>The attack that launched the human resistance.</quote>
<stats>
...
<lore>
<p>The opening engagement of the Proxima War. Derrulicant forces launched a raid on Bran Davis civilian mining platform.</p>
<p>Bran fled the platform in his &lt;span class='wiki-link' data-id='suv'&gt;SUV&lt;/span&gt;. He was picked up by an Enclave warship, receiving command after the ship captain died of the carrier virus.</p>
</lore>
</entry>
...
<category>Major Event</category>
<tagClass>tag-event</tagClass>
<quote>The siege of the Derrulicant Star Forge project.</quote>
<stats>
...
<lore>
<p>Syndicate dropships discovered that the Derrulicants were attempting to construct a secondary Star Forge on Startis.</p>
<p>Bran Davis coordinated a dropship campaign, raiding and leveling the factory complex to preserve the balance of system resources.</p>
</lore>
</entry>
...
<category>Major Event</category>
<tagClass>tag-event</tagClass>
<quote>The skirmish that angered the Enclave Purists.</quote>
<stats>
...
<lore>
<p>While scavenging an abandoned Derrulicant mining yard, Bran miners disturbed an Enclave Caspium graveyard.</p>
<p>The religious Purist subfaction attacked, forcing infantry to establish a bunker line to defend the pipeline.</p>
</lore>
</entry>
...
<category>Major Event</category>
<tagClass>tag-event</tagClass>
<quote>The retreat that shattered the alliance.</quote>
<stats>
...
<lore>
<p>During an offensive against a Biomass hive cluster, King Prius ordered Enclave support forces to retreat to orbit, leaving the Syndicates stranded.</p>
<p>Bran crew escaped by hijacking orbital transports, ending the human-Enclave alliance.</p>
</lore>
</entry>
...
<category>Major Event</category>
<tagClass>tag-event</tagClass>
<quote>The vaporization of the accidental hero.</quote>
<stats>
<stat label="Location">Prius Private Chambers</stat>
<stat label="Target">King Prius</stat>
<stat label="Execution Method">Automated Caspium Ceiling Crystal</stat>
</stats>
<lore>
<p>Guided by the words of the dead Elder, Bran Davis snuck into Prius secure meeting chambers to execute him.</p>
<p>He located Prius conversing with hologram feeds. Right as Bran drew his &lt;span class='wiki-link' data-id='cd-13-rifle'&gt;CD-13 rifle&lt;/span&gt;, Prius paid him no attention; the automated security crystal in the ceiling vaporized Bran.</p>
</lore>
</entry>
</database>
